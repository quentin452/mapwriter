...
public class MwGuiTextDialog extends GuiScreen {
    private static final int textDialogWidthPercent = 50;
    private static final int textDialogTitleY = 80;
    private static final int textDialogY = 92;
    private static final int textDialogErrorY = 108;
    ...
    protected boolean backToGameOnSubmit = false;
