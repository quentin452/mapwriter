...
public class MwGuiMarkerDialogNew extends GuiScreen {
    private static final String editMarkerName = "mw.gui.mwguimarkerdialognew.editMarkerName";
    private static final String editMarkerGroup = "mw.gui.mwguimarkerdialognew.editMarkerGroup";
    private static final String editMarkerX = "mw.gui.mwguimarkerdialognew.editMarkerX";
    private static final String editMarkerY = "mw.gui.mwguimarkerdialognew.editMarkerY";
    private static final String editMarkerZ = "mw.gui.mwguimarkerdialognew.editMarkerZ";
    private static final String titleNew = "mw.gui.mwguimarkerdialognew.title.new";
    private static final boolean backToGameOnSubmit = false;
    private static final int dialogWidthPercent = 40;
    private static final int elementVSpacing = 20;
    private final ResourceLocation leftArrowTexture = new ResourceLocation(Tags.MODID, "textures/map/arrow_text_left.png");
    private final ResourceLocation rightArrowTexture = new ResourceLocation(Tags.MODID, "textures/map/arrow_text_right.png");
    private final GuiScreen parentScreen;
    private final MarkerManager markerManager;
    private final String title;
    private final int dimension;
    private ScrollableTextBox scrollableTextBoxName;
    private ScrollableTextBox scrollableTextBoxGroup;
    private ScrollableNumericTextBox scrollableNumericTextBoxX;
    private ScrollableNumericTextBox scrollableNumericTextBoxY;
    private ScrollableNumericTextBox scrollableNumericTextBoxZ;
    ...
    private class ScrollableTextBox {
        public int x;
        public int y;
        public int width;
        public int labelX;
    ...
    public void initGui() {
        ...
        this.scrollableTextBoxGroup = new ScrollableTextBox(x, y
                + elementVSpacing, width, I18n.format(editMarkerGroup),
        ...
        this.scrollableNumericTextBoxX = new ScrollableNumericTextBox(x, y
                + elementVSpacing * 2, width, I18n.format(editMarkerX));
        ...
        this.scrollableNumericTextBoxY = new ScrollableNumericTextBox(x, y
                + elementVSpacing * 3, width, I18n.format(editMarkerY));
        ...
        this.scrollableNumericTextBoxZ = new ScrollableNumericTextBox(x, y
                + elementVSpacing * 4, width, I18n.format(editMarkerZ));
    ...
    public void drawScreen(int mouseX, int mouseY, float f) {
        ...
        drawRect(
                ...
                (this.width - w) / 2 + w,
                (this.height - elementVSpacing * 7) / 2
                        + elementVSpacing * 6,
                0x80000000);
    ...
    protected void keyTyped(char c, int key) {
        switch (key) {
            ...
            case Keyboard.KEY_TAB:
                GuiTextField thistextField;
                GuiTextField prevtextField;
                GuiTextField nexttextField;
